...
const HomePage: NextPage = () => {
  return (
    <Layout>
      <div className="w-full max-w-2xl flex flex-wrap sm:flex-nowrap">
        <div className="flex-1 basis-full sm:basis-auto">
          ...
          <p className="mt-6 text-base text-zinc-600">
            My name is Enzo and I&apos;m providing technical leadership to young
            teams.
            <br />
            <br />
        ...
        <div className="shrink-0 mt-10 sm:mt-0 sm:ml-5 flex flex-col items-center">
          <Image
            alt=""
            src={me}
            width="512"
